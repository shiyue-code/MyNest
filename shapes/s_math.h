...
public:
    ...
    //    inline Rational(double d)
    //        : num(T((d + std::numeric_limits<double>::epsilon()) * pow(10, std::numeric_limits<double>::digits10)))
    //        , den(T(pow(10, std::numeric_limits<double>::digits10)))
    //    {
    //        normsign();
    //        normalize();
    //    }

    //    inline Rational(float f)
    //        : num(T((f + std::numeric_limits<float>::epsilon()) * pow(10, std::numeric_limits<float>::digits10)))
    //        , den(T(pow(10, std::numeric_limits<float>::digits10)))
    //    {
    //        normsign();
    //        normalize();
    //    }

    //    inline Rational(long double ld)
    //        : num(T(ld * pow(10, std::numeric_limits<long double>::digits10)))
    //        , den(T(pow(10, std::numeric_limits<long double>::digits10)))
    //    {
    //        normsign();
    //        normalize();
    //    }
